...
class Supplier_payments extends MY_Controller {
    ...
    public function index() {
        ...
        $data['business_contact_options'] = $this->Business_contacts_model->getOptionsSelect2(2);
       $data['business_contact_type']=2;
