            ...
            <table class="table table-bordered table-responsive transaction_table">
                <thead>
                    <tr>
                        ...
                        <th width="7%">Pur #</th>
                        <th  width="7%">Bill #</th>
                        <th  width="15%">Supplier Detail </th>
                        <th  width="10%">Product details  </th>
                        <th  width="15%">Bill Value  </th>
                        <th  width="15%">Return Memo  </th>
                        <th  width="15%">Discount allowed </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            fields: [
                ...
                {name: "mode_id",
                    ...
                    textField: "mode_name"
                        ...
                        {name: "pdc_dated",css:"datepicker", title: "PDC dated", type: "text", width: 80, align: "left"},
                          {name: "ref_no", title: "CQ No/Ref no", type: "text", width: 80,  align: "left"},
                {name: "bank_name", title: "Bank", type: "text", width: 80,  align: "left"},
