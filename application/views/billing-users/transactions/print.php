...
<section class='bill_body'>
    <div class="header bggrey" style="border-top:solid 1px #444;border-left:solid 1px #444;border-right:solid 1px #444;">
        <div class="row ">

                                                                                        <div class="invoice-title col-md-12 col-xs-12 text-center">                <!--<img src="<?php echo assets_url('img/logo.png'); ?>" height="65"/>-->
             <span class="pull-left"><strong>GSTIN: <?php echo $company_details['gstin']; ?></strong></span>   <h1 style="color:red">MKM Agencies</h1>
            ...
            <div class="right-top col-xs-12 "  ><address class="text-center">
                    ...
                    <?php foreach (explode("@", $company_details['company_address']) as $key => $value) {
                        ?>
                      <?php echo $value; ?> <i class="fa fa-phone"></i>  <?php echo $company_details['company_mobile']; ?>&nbsp
 ...
 <div class="col-xs-12  pull-left"> <?php if($transaction_details['dispatched_to']!= ""): ?>Place Of Supply : <?php echo $transaction_details['dispatched_to'];  endif; ?> </div>
   

                            </div>
                        <div class="row" style="margin-top: 5px; padding-left: 10px;">
                            
 <div class="col-xs-5  pull-left"> <?php if($transaction_details['gstin']!= ""): ?>Party's GSTIN: <?php echo $transaction_details['gstin'];  endif; ?> </div>
                ...
                <div class=" col-xs-12 nopadding product_table">
                    <table class="table table-bordered ">
                        ...
                        <tbody height="500">
                            ...
                            $min_height=300;
                            $height_needed=$no_of_products*10;
                          ...
                          $only_total=0;
                            ...
                            <?php } ?>
                                <tr style="height: <?php echo $last_tr_height-30; ?>px;">
                                    <td  colspan=""></td>  
                                      <td  colspan=""></td>  
                                ...
                                <tr style="height: <?php echo "30px"; ?>;">
                                      <td  colspan=""></td>  
                                      <td ><b>(As Per Sample and Customer Specification)</b></td>  
                  ...
                  <td  colspan="<?php echo 7-$colspan_minus; ?>"class="bggrey"></strong>
                                    
                                    <strong  class="pull-right"> Total</strong></td>                            <td class=" text-right"><?php
                           ...
                           <tr class="borderless">
                                ...
                                <td  colspan="<?php echo 7-$colspan_minus; ?>"class=" text-center"><strong  class="pull-right"> Total Tax</strong></td>
                                <td class=" text-right"><?php
                                   
                                    echo $sgst_total+$igst_total+$cgst_total;
                                    ?></td>
                            </tr>
...
<div class="footer">
        <div class="row">
            <div class="col-xs-7">
               <!-- <p class='underline half-margin'>Terms & Condition:</p>
            ...
            <div class="col-xs-5">
                <p class='text-right'>For MKM Agencies</p>
