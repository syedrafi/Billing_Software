    ...
    $(function () {
        ...
        var $grid = $("#contactsGrid").jsGrid({
            ...
            fields: [
                ...
                {name: "tin_no", title: "TIN", type: "text", width: 80,align:"left"},
                 {name: "cst_no", title: "CST", type: "text", width: 80,align:"left"},
                 {name: "dl_no", title: "DL No.", type: "text", width: 80,align:"left"},
